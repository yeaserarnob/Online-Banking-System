	...
	<h2 style="text-align:center"> UrAdHuRa Online Transfer Portal </h2>
                ...
                <div class="displaystaff_content">
					...
					<table align="center">
                        ...
                        <td>							
								 Enter The Amount: <input type="text" name="lamount" id="button"> &nbsp
								<input type="submit" name="applyloan" id="button" value="Apply For Loan" > &nbsp												
							</form>
					</table>
					...
					<table align="center">
							<form method="POST" action="loan.php";>
                        <td>							
								 Enter The Amount: <input type="text" name="damount" id="button"> &nbsp
								<input type="submit" name="payloan" id="button" value="Pay Loan" > &nbsp												
							</form>
					</table>
